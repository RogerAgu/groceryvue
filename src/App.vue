...
<template>
  <main>
    <h1 class="title"> My Vue Grocery list</h1>
...
main{
  ...
  .title{
  @apply mt-8 font-bold text-7xl m-2 tracking-wider text-accent;
  }
  form{
  ...
  ul {
    @apply flex flex-col items-center rounded-lg bg-comment;
    li {
